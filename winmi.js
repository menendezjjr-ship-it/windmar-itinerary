...
var WINMI_KEY="39a049e816c01c2e9dc908307212ff08e0cdf5327469161980d29df454b78cf9"; // app-key gate  mismo valor que APP_API_KEY en Vercel
  ...
  function droid(px){ return '<svg viewBox="0 0 120 152" width="'+px+'" height="'+Math.round(px*1.27)+'" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="display:block;overflow:visible">'+'<defs>'+'<radialGradient id="wmGlass" cx="42%" cy="36%" r="66%"><stop offset="0" stop-color="#a9d4ff" stop-opacity="0.16"/><stop offset="0.55" stop-color="#2b5aa8" stop-opacity="0.10"/><stop offset="0.84" stop-color="#bfe0ff" stop-opacity="0.12"/><stop offset="0.94" stop-color="#e9f5ff" stop-opacity="0.60"/><stop offset="1" stop-color="#8fbdf0" stop-opacity="0.10"/></radialGradient>'+'<radialGradient id="wmCore" cx="50%" cy="55%" r="55%"><stop offset="0" stop-color="#7fe6ff" stop-opacity="0.9"/><stop offset="0.45" stop-color="#2b8fe0" stop-opacity="0.5"/><stop offset="1" stop-color="#12306e" stop-opacity="0"/></radialGradient>'+'<linearGradient id="wmPanel" x1="0" y1="0" x2="0.3" y2="1"><stop offset="0" stop-color="#18356a"/><stop offset="1" stop-color="#0a1a3c"/></linearGradient>'+'<radialGradient id="wmEyeG" cx="45%" cy="40%" r="65%"><stop offset="0" stop-color="#e6fdff"/><stop offset="0.55" stop-color="#33e1ff"/><stop offset="1" stop-color="#0fa6d6"/></radialGradient>'+'<linearGradient id="wmSunG" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#FFD54A"/><stop offset="1" stop-color="#F89B24"/></linearGradient>'+'<filter id="wmGlow" x="-60%" y="-60%" width="220%" height="220%"><feGaussianBlur stdDeviation="1.5" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter>'+'</defs>'+'<ellipse cx="60" cy="142" rx="30" ry="5" fill="#000" opacity="0.26"/>'+'<circle class="wmSunGlowC" cx="60" cy="74" r="50" fill="url(#wmCore)" opacity="0.5"/>'+'<g><animateTransform attributeName="transform" attributeType="XML" type="rotate" values="-2.4 60 74;2.4 60 74;-2.4 60 74" dur="6.5s" repeatCount="indefinite"/>'+'<circle cx="60" cy="74" r="46" fill="url(#wmGlass)" stroke="#bfe0ff" stroke-opacity="0.5" stroke-width="1"/>'+'<circle cx="60" cy="74" r="45" fill="none" stroke="#e2f1ff" stroke-opacity="0.85" stroke-width="1.3" stroke-linecap="round" stroke-dasharray="55 250"><animateTransform attributeName="transform" type="rotate" from="0 60 74" to="360 60 74" dur="7s" repeatCount="indefinite"/></circle>'+'<circle cx="60" cy="80" r="30" fill="url(#wmCore)" opacity="0.5"/>'+'<g fill="#cdf3ff"><circle cx="47" cy="63" r="1.2"><animate attributeName="cy" values="66;57;66" dur="3.4s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.2;0.9;0.2" dur="3.4s" repeatCount="indefinite"/></circle><circle cx="73" cy="83" r="1"><animate attributeName="cy" values="86;78;86" dur="4.2s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.15;0.8;0.15" dur="4.2s" repeatCount="indefinite"/></circle><circle cx="66" cy="60" r="0.9"><animate attributeName="cy" values="62;55;62" dur="3s" repeatCount="indefinite"/><animate attributeName="opacity" values="0.2;0.85;0.2" dur="3s" repeatCount="indefinite"/></circle></g>'+'<rect x="41" y="53" width="38" height="44" rx="5" fill="url(#wmPanel)" stroke="#4f86d6" stroke-width="1"/>'+'<g stroke="#5b93e0" stroke-width="0.6" opacity="0.6"><line x1="54" y1="53" x2="54" y2="97"/><line x1="66.5" y1="53" x2="66.5" y2="97"/><line x1="41" y1="64" x2="79" y2="64"/><line x1="41" y1="75" x2="79" y2="75"/><line x1="41" y1="86" x2="79" y2="86"/></g>'+'<g filter="url(#wmGlow)"><rect class="wmSunEye" x="47.5" y="66" width="9" height="12" rx="4.5" fill="url(#wmEyeG)"/><rect class="wmSunEye" x="63.5" y="66" width="9" height="12" rx="4.5" fill="url(#wmEyeG)"/></g>'+'<path class="wmSunMouth" d="M50 87 Q60 94 70 87" fill="none" stroke="url(#wmSunG)" stroke-width="3.4" stroke-linecap="round" filter="url(#wmGlow)"/>'+'<ellipse cx="46" cy="52" rx="14" ry="8" fill="#ffffff" opacity="0.3" transform="rotate(-24 46 52)"/><circle cx="43" cy="48" r="2.6" fill="#ffffff" opacity="0.55"/>'+'</g>'+'</svg>'; }
  ...
  st.textContent=[
    ...
    ".wmSunPanel{position:fixed;right:16px;bottom:calc(16px + env(safe-area-inset-bottom,0px));width:440px;max-width:calc(100vw - 24px);height:600px;max-height:82vh;z-index:1650;background:linear-gradient(180deg,#0e1c3b,#0a1326);background:rgba(13,22,38,.66);-webkit-backdrop-filter:blur(24px) saturate(150%);backdrop-filter:blur(24px) saturate(150%);border:1px solid rgba(100,210,255,.25);border-radius:22px;display:flex;flex-direction:column;overflow:hidden;box-shadow:inset 0 1px 0 0 rgba(255,255,255,.15),inset 0 0 46px rgba(60,140,220,.07),0 20px 40px rgba(0,0,0,.5),0 30px 72px -14px rgba(0,0,0,.6);animation:wmSunUp .34s cubic-bezier(.22,1.1,.4,1) both}",
    ...
    ".wmSunHdr{display:flex;align-items:center;gap:10px;padding:12px 13px;background:linear-gradient(180deg,rgba(20,34,58,.55),rgba(13,22,38,0));border-bottom:1px solid rgba(120,220,255,.14);flex-shrink:0;box-shadow:inset 0 1px 0 rgba(255,255,255,.12)}",
    ".wmSunBody{flex:1;overflow-y:auto;-webkit-overflow-scrolling:touch;padding:14px;display:flex;flex-direction:column;gap:11px;background:radial-gradient(135% 60% at 50% -6%,rgba(40,90,150,.14),transparent 60%)}",
    ".wmSunFoot{flex-shrink:0;padding:10px;border-top:1px solid rgba(120,220,255,.14);background:linear-gradient(0deg,rgba(20,34,58,.6),rgba(13,22,38,0));display:flex;gap:8px;align-items:flex-end}",
    ...
    ".wmB.b{align-self:flex-start;background:rgba(25,40,70,.42);-webkit-backdrop-filter:blur(6px);backdrop-filter:blur(6px);color:#eef4ff;border:1px solid rgba(120,220,255,.18);border-bottom-left-radius:6px;white-space:normal;text-shadow:0 0 10px rgba(120,200,255,.14);box-shadow:inset 0 1px 0 rgba(255,255,255,.12),0 6px 16px rgba(0,0,0,.28),0 0 22px -14px rgba(56,225,255,.3)}",
    ...
    ".wmChips{display:flex;flex-wrap:wrap;gap:6px;margin-top:9px;align-self:flex-start;max-width:92%;animation:wmBIn .3s ease both}",".wmChip{background:rgba(25,40,70,.4);-webkit-backdrop-filter:blur(6px);backdrop-filter:blur(6px);border:1px solid rgba(120,220,255,.18);color:#dbe9ff;border-radius:20px;padding:8px 13px;font:600 12px Montserrat,system-ui,sans-serif;cursor:pointer;white-space:nowrap;text-shadow:0 0 8px rgba(120,200,255,.16);box-shadow:inset 0 1px 0 rgba(255,255,255,.12),0 4px 12px rgba(0,0,0,.22);transition:transform .14s ease,box-shadow .14s ease,background .14s ease,border-color .14s ease}",".wmChip:hover{transform:translateY(-1px);background:rgba(30,52,88,.55);border-color:rgba(100,210,255,.45);box-shadow:inset 0 1px 0 rgba(255,255,255,.2),0 0 18px rgba(100,210,255,.22),0 8px 18px -6px rgba(0,0,0,.4)}",".wmGal{display:grid;grid-template-columns:repeat(3,1fr);gap:6px;margin-top:9px;align-self:stretch;width:100%;animation:wmBIn .34s ease both}",".wmGal a{display:block;border-radius:11px;overflow:hidden;border:1px solid #2f5596;background:#0a1526;aspect-ratio:1/1;box-shadow:0 6px 16px -10px rgba(0,0,0,.6)}",".wmGal img{width:100%;height:100%;object-fit:cover;display:block;transition:transform .25s ease}",".wmGal a:hover img{transform:scale(1.07)}",
    ".wmChip:active{transform:translateY(0) scale(.96);filter:brightness(.95)}",
    ".wmSunIn{flex:1;min-height:42px;max-height:110px;resize:none;border-radius:14px;border:1px solid rgba(120,220,255,.18);background:rgba(8,15,28,.55);color:#fff;padding:11px 13px;font:500 16px Montserrat,system-ui,sans-serif;outline:none;box-shadow:inset 0 2px 6px rgba(0,0,0,.4),inset 0 1px 0 rgba(255,255,255,.05);transition:border-color .14s ease,box-shadow .14s ease}",".wmSunIn:focus{border-color:rgba(100,210,255,.5);box-shadow:inset 0 2px 6px rgba(0,0,0,.4),0 0 0 3px rgba(100,210,255,.14)}",
    ".wmSunBtn{flex-shrink:0;width:44px;height:44px;border-radius:14px;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:19px;transition:box-shadow .16s ease,filter .16s ease,transform .1s ease}",".wmChrome{color:#d5ecff;background:linear-gradient(180deg,rgba(60,84,120,.55),rgba(24,38,62,.6));border:1px solid rgba(150,200,255,.22);box-shadow:inset 0 1px 0 rgba(255,255,255,.28),inset 0 -2px 4px rgba(0,0,0,.3)}",".wmChrome:hover{filter:brightness(1.1);box-shadow:inset 0 1px 0 rgba(255,255,255,.4),0 0 14px rgba(100,210,255,.3)}",".wmSend{color:#fff;background:linear-gradient(180deg,#3ea9ff,#1c6fd0 62%,#F89B24 190%);border:1px solid rgba(180,225,255,.5);box-shadow:inset 0 1px 0 rgba(255,255,255,.5),0 0 18px rgba(60,150,255,.5)}",".wmSend:hover{box-shadow:inset 0 1px 0 rgba(255,255,255,.6),0 0 24px rgba(60,160,255,.72)}",".wmSunBtn:active{transform:scale(.94)}",
  ...
  function openPanel(){ if(panel){ return; } if(hi){ hi.remove(); hi=null; }
    ...
    panel.innerHTML='<div class="wmSunHdr"><span style="flex-shrink:0;display:inline-flex;filter:drop-shadow(0 0 8px rgba(248,155,36,.6))">'+droid(44)+'</span>'
      ...
      +'<button id="wmSunCam" class="wmSunBtn wmChrome" title="'+T("Add a photo or PDF","Agregar foto o PDF")+'">📎</button>'
      +(SR?'<button id="wmSunMic" class="wmSunBtn wmChrome" title="'+T("Talk to me","Háblame")+'">🎤</button>':"")
      +'<button id="wmSunSend" class="wmSunBtn wmSend">➤</button></div>';
